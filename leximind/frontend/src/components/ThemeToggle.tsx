...
// Exact recreation of the sparkle toggle from the original HTML/CSS.
...
export default function ThemeToggle() {
  ...
  return (
    <div className="toggle-cont" style={{ position: "absolute", top: 10, right: 10, zIndex: 20 }}>
      <input
      ...
      <label className="toggle-label" htmlFor="theme-toggle">
        <div className="cont-icon">
          {[
            { w: 2, d: 25, dur: 11 }, { w: 1, d: 100, dur: 18 }, { w: 1, d: 280, dur: 5 },
            { w: 2, d: 200, dur: 3 }, { w: 2, d: 30, dur: 20 }, { w: 2, d: 300, dur: 9 },
            { w: 1, d: 250, dur: 4 }, { w: 2, d: 210, dur: 8 }, { w: 2, d: 100, dur: 9 },
            { w: 1, d: 15, dur: 13 }, { w: 1, d: 75, dur: 18 }, { w: 2, d: 65, dur: 6 },
            { w: 2, d: 50, dur: 7 }, { w: 1, d: 320, dur: 5 }, { w: 1, d: 220, dur: 5 },
          ].map((s, i) => (
            <span
              key={i}
              className="sparkle"
              style={{ "--width": s.w, "--deg": s.d, "--duration": s.dur } as React.CSSProperties}
            />
          ))}
